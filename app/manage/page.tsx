    ...
    <div className="max-w-2xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-md p-8">
        ...
        <p className="text-gray-600 mb-6">
          Enter your booking reference and last name to view and manage your
          booking
        </p>
          ...
          >
            {isLoading ? (
              <>
                ...
                <span className="ml-2">Retrieving Booking...</span>
              </>
            ) : (
              "Retrieve Booking"
            )}
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      {booking.status !== "CANCELLED" && modificationOptions.length > 0 && (
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h2 className="text-xl font-semibold mb-4">Manage Your Booking</h2>
          <div className="space-y-3">
            {modificationOptions.map((option) => (
              ...
              >
                <div>
                  <p className="font-medium">
                    {option.type === "change-flight" && "Change Flight"}
                    {option.type === "change-seats" && "Change Seats"}
                    {option.type === "add-extras" && "Add Extras"}
                  </p>
                  {option.available && option.fee > 0 && (
                    <p className="text-sm text-gray-600">
                      Fee: {booking.currency} {option.fee.toFixed(2)}
                    </p>
                  )}
                  {!option.available && (
                ...
                >
                  {option.available ? "Modify" : "Unavailable"}
                </button>
              </div>
            ))}
          </div>
      ...
      <div className="flex gap-4 justify-center">
        <button
          onClick={() => router.push(`/confirmation?ref=${booking.reference}`)}
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-lg p-6 max-w-md w-full">
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold mb-4">Booking Cancelled</h3>
